...
static PyObject *__pyx_f_10fluxclient_5utils_6_utils_5Tools_path_to_js(CYTHON_UNUSED struct __pyx_obj_10fluxclient_5utils_6_utils_Tools *__pyx_v_self, PyObject *__pyx_v_path, int __pyx_skip_dispatch) {
  ...
  std::vector<std::vector<std::vector<float> > >  __pyx_t_6;
  __Pyx_RefNannySetupContext("path_to_js", 0);
  /* Check if called by wrapper */
  if (unlikely(__pyx_skip_dispatch)) ;
  /* Check if overridden in Python */
  else if (unlikely(Py_TYPE(((PyObject *)__pyx_v_self))->tp_dictoffset != 0)) {
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self), __pyx_n_s_path_to_js); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
    ...
    if (!PyCFunction_Check(__pyx_t_1) || (PyCFunction_GET_FUNCTION(__pyx_t_1) != (PyCFunction)__pyx_pw_10fluxclient_5utils_6_utils_5Tools_3path_to_js)) {
      ...
      if (!__pyx_t_4) {
        __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_v_path); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  /* "src/utils/utils.pyx":17
 * 
 *     cpdef path_to_js(self, path):
 *         return path_to_js(path)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_6 = __pyx_convert_vector_from_py_std_3a__3a_vector_3c_std_3a__3a_vector_3c_float_3e____3e___(__pyx_v_path); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L1_error)
  __pyx_t_1 = __pyx_convert_PyBytes_string_to_py_std__in_string(path_to_js(__pyx_t_6)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pf_10fluxclient_5utils_6_utils_5Tools_2path_to_js(struct __pyx_obj_10fluxclient_5utils_6_utils_Tools *__pyx_v_self, PyObject *__pyx_v_path) {
  ...
  __Pyx_RefNannySetupContext("path_to_js", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_10fluxclient_5utils_6_utils_5Tools_path_to_js(__pyx_v_self, __pyx_v_path, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
#endif
{
  ...
  if (PyType_Ready(&__pyx_type_10fluxclient_5utils_6_utils_Tools) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __pyx_type_10fluxclient_5utils_6_utils_Tools.tp_print = 0;
  if (__Pyx_SetVtable(__pyx_type_10fluxclient_5utils_6_utils_Tools.tp_dict, __pyx_vtabptr_10fluxclient_5utils_6_utils_Tools) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  if (PyObject_SetAttrString(__pyx_m, "Tools", (PyObject *)&__pyx_type_10fluxclient_5utils_6_utils_Tools) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
