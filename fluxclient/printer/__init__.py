...
def finite_choice(key, value, white_list):
    if value in white_list:
        ...
        return 'Invalid value: %s, must be one of %s' % (value, repr(white_list)[1:-1])
...
def hex_color(key, value):
    ...
    try:
        ...
        return 'Invalid value: %s, must be a hex color' % (value)
...
ini_constraint = {
    ...
    'end_gcode': [free],
    'external_fill_pattern': [finite_choice, ['auto', 'line', 'rectilinear', 'honeycomb']],
    ...
    'fill_pattern': [finite_choice, ['auto', 'line', 'rectilinear', 'honeycomb']],
